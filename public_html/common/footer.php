...
<body>
  ...
  <div class="flex-rw">
    ...
    <ul class="footer-list-top">
      <li>
        <h4 class="footer-list-header">About Waste To Art</h4>
      </li>
    ...
    <ul class="footer-list-top">
      <li>
        <h4 class="footer-list-header">Major Catagories</h4>
      </li>
      <li><a class="generic-anchor footer-list-anchor" target="_blank">METAL</a></li>
      <li><a class="generic-anchor footer-list-anchor" target="_blank">PAPER</a></li>
    ...
    <ul class="footer-list-top">
      ...
      <li><a href='#' class="generic-anchor footer-list-anchor" itemprop="significantLink" target="_blank">CONTACT</a></li>
    ...
    <section class="footer-bottom-section flex-rw">
      <div class="footer-bottom-wrapper">
        <i class="fa " role="copyright">

        </i> ©2022 Waste To Art <address class="footer-address" role="company address">Nepal</address><span class="footer-bottom-rights"> - All Rights Reserved</span>

      </div>

      <div class="footer-bottom-wrapper">
        <span class='email'> Email : wta@gmail.com</span>
